...
```
after the removal of the liver and age variables due to insiginifcant p-values, the Residauls vs fitted and QQplot still have curvatures.
...
ftest
```
the null distribution is that none of the predictor variables have an effect on survival time from a liver operation.
